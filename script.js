    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "aura business משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e00d1545-8523-476b-a48f-ceff05c57080',
                    name: data.name || '',
                    email: data.email || '',
